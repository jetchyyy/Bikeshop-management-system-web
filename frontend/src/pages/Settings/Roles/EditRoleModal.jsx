...
const EditRoleModal = ({ showModal, setShowModal, role, onEditRole }) => {
  ...
  useEffect(() => {
    if (role) {
      ...
      setPermissions({
        accessInventory: role.permissions?.accessInventory || false,
        accessHistory: role.permissions?.accessHistory || false,
        accessAttendance: role.permissions?.accessAttendance || false,
        accessAnalytics: role.permissions?.accessAnalytics || false,
        accessNewCustomer: role.permissions?.accessNewCustomer || false,
        accessSettings: role.permissions?.accessSettings || false,
      });
    }
  }, [role]);
